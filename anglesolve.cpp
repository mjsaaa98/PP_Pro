 ...
 */
void AngleSolve::GetPosition2d(vector<Point2f> vertices,vector<Point2f> & position2d,Point2f offset)
{
    Point2f lu, ld, ru, rd;
...
bool AngleSolve::Rotated_SolveAngle(vector<Point2f> rect, double & angle_P, double & angle_Y, double &dis, Mat& camera_location, double speed_bullet, double current_ptz_angle, const cv::Point2f & offset)
{
    vector<Point2f> target2d;
//    Rect_GetPosition2d(rect,target2d,offset);
    GetPosition2d(rect,target2d,offset);
