...
public:
    ...
    void GetPosition2d(vector<Point2f> vertices,vector<Point2f> & position2d,Point2f offset = Point2f(0,0));
...
//    bool SolveAngle(const vector<Point2f>, double & angle_P, double & angle_Y, double speed_bullet, double current_ptz_angle, const cv::Point2f & offset);
    bool Rotated_SolveAngle(vector<Point2f>, double & angle_P, double & angle_Y, double &dis,  Mat& camera_location,double speed_bullet, double current_ptz_angle, const cv::Point2f & offset);
